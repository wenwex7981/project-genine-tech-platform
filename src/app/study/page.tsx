      ...
      <div className="container mx-auto px-4 md:px-6 mt-8 max-w-7xl">
        ...
        <div className="space-y-6 mb-12">
          ...
          <div className="flex justify-center w-full">
            <div className="inline-flex w-full md:w-auto overflow-x-auto no-scrollbar bg-white dark:bg-zinc-900 p-1.5 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
              <button
                onClick={() => setActiveTab("interview-prep")}
                className={`px-4 sm:px-5 py-2.5 text-sm font-bold rounded-xl transition-all duration-200 flex items-center gap-2 whitespace-nowrap ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto">
            <Link href="/study/interview-prep/mock-interview" className="group">
              <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4 flex items-center gap-4 hover:border-violet-300 dark:hover:border-violet-600 shadow-sm hover:shadow-[0_4px_20px_rgba(139,92,246,0.08)] active:scale-95 transition-all duration-300">
                <div className="w-12 h-12 rounded-xl bg-violet-50 dark:bg-violet-900/30 border border-violet-200/60 dark:border-violet-700/40 flex items-center justify-center shrink-0">
                  <Mic className="w-6 h-6 text-violet-600 dark:text-violet-400" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="text-[15px] font-bold text-zinc-900 dark:text-zinc-100 group-hover:text-violet-700 dark:group-hover:text-violet-400 transition-colors">Voice Mock Interview</div>
                  <div className="text-xs font-medium text-zinc-500 dark:text-zinc-400 mt-0.5">AI-powered practice</div>
                </div>
                <div className="text-zinc-300 dark:text-zinc-600 group-hover:text-violet-500 group-hover:translate-x-1 transition-all">
            ...
            <Link href="/study/interview-prep/communication-builder" className="group">
              <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4 flex items-center gap-4 hover:border-rose-300 dark:hover:border-rose-600 shadow-sm hover:shadow-[0_4px_20px_rgba(244,63,94,0.08)] active:scale-95 transition-all duration-300">
                <div className="w-12 h-12 rounded-xl bg-rose-50 dark:bg-rose-900/30 border border-rose-200/60 dark:border-rose-700/40 flex items-center justify-center shrink-0">
                  <Sparkles className="w-6 h-6 text-rose-600 dark:text-rose-400" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="text-[15px] font-bold text-zinc-900 dark:text-zinc-100 group-hover:text-rose-700 dark:group-hover:text-rose-400 transition-colors">Self-Intro Builder</div>
                  <div className="text-xs font-medium text-zinc-500 dark:text-zinc-400 mt-0.5">Perfect your pitch</div>
                </div>
                <div className="text-zinc-300 dark:text-zinc-600 group-hover:text-rose-500 group-hover:translate-x-1 transition-all">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
                </div>
              </div>
            </Link>
            ...
            <Link href="/study/interview-prep/english-friend" className="group">
              <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4 flex items-center gap-4 hover:border-emerald-300 dark:hover:border-emerald-600 shadow-sm hover:shadow-[0_4px_20px_rgba(16,185,129,0.08)] active:scale-95 transition-all duration-300">
                <div className="w-12 h-12 rounded-xl bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200/60 dark:border-emerald-700/40 flex items-center justify-center shrink-0">
                  <MessageCircle className="w-6 h-6 text-emerald-600 dark:text-emerald-400" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="text-[15px] font-bold text-zinc-900 dark:text-zinc-100 group-hover:text-emerald-700 dark:group-hover:text-emerald-400 transition-colors">English Friend Alex</div>
                  <div className="text-xs font-medium text-zinc-500 dark:text-zinc-400 mt-0.5">Conversational fluency</div>
                </div>
                <div className="text-zinc-300 dark:text-zinc-600 group-hover:text-emerald-500 group-hover:translate-x-1 transition-all">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
                </div>
              </div>
            </Link>
