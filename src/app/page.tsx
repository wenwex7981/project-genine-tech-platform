...
const SERVICES = [
  ...
  },
  {
    ...
    description: "Our expert team crafts completely original IEEE Research Papers, SRS documents, and project reports that are certified to pass Turnitin, iThenticate, and university plagiarism checks.",
    features: ["IEEE Format Research Papers", "SRS & System Design Docs", "Turnitin Certified Safe", "University-Specific Formatting"],
    badge: "High Demand",
  },
  {
    ...
    description: "Advanced AI content humanizer that rewrites AI-generated text to pass GPTZero, Copyleaks, Turnitin AI Detection, and Winston AI detectors with 99% human-score accuracy.",
    features: ["GPTZero & Turnitin Bypass", "Semantic Preservation", "Academic Tone Maintained", "Bulk Text Processing"],
    badge: "Exclusive",
  },
  {
...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    text: "The AI Humanizer turned my entire 40-page thesis from AI-detected to 0% on Turnitin. The academic tone was perfectly preserved. I would have never passed without this tool.",
    rating: 5,
  },
  {
    name: "Rahul Nair",
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <section className="relative w-full min-h-[92vh] flex items-center bg-zinc-950 overflow-hidden text-white">
        ...
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-orange-500/10 rounded-full blur-[100px] translate-y-1/3 -translate-x-1/3 pointer-events-none" />
